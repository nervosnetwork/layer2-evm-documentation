...
The SUDT-ERC20 Proxy Solidity smart contract below is `SudtERC20Proxy.sol`, and it is located in the [`layer2-evm-documentation/code-examples/5-erc20-proxy/contracts/SudtERC20Proxy.sol](../examples/5-erc20-proxy/contracts/SudtERC20Proxy.sol) file.
...
You need to prepare *Layer 1 SUDT Issuer Lock Hash (AKA SUDT Type Args)* and use [`src/examples/5-erc20-proxy/get-sudt-id.js`](../code-examples/5-erc20-proxy/get-sudt-id.js).
