...
Don't worry though, it's extremely easy to go from the Ethereum to Polyjuice address and vice-versa. The example code to demonstrate this is included in [`code-examples/5-erc20-proxy/check-sudt-balance.js`](../code-examples/5-erc20-proxy/check-sudt-balance.js). You can also use `account-cli` tool to do a one time conversion using command-line. The instructions for `account-cli` can be found [here](../component-tutorials/3.setup.and.use.account.cli.md#address-conversion).
...
➜ node check-sudt-balance.js
Using Ethereum address: 0xD173313A51f8fc37BcF67569b463abd89d81844f
Corresponding Polyjuice address: 0x8016dcd1af7c8cceda53e4d2d2cd4e2924e245b6
