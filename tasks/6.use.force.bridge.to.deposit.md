...
Open the example code from [`layer2-evm-documentation/code-examples/6-bridge/index.js`](https://github.com/Kuzirashi/gw-gitcoin-instruction/tree/master/src/examples/6-bridge/index.js) in an editor of your choosing.
