...
If you would like to check your Layer 2 token balance, you can repeat the steps from the [previous task](5.deploy.erc20.proxy.contract.md) for one of the tokens from Force Bridge. This is not a requirement for task submission, but you are encouraged to do so to verify that the tokens have arrived safely in your account.
